...
y=\frac{e^{-2x}}{4}(x^4+4),
\end{equation}
which can be obtained by the method of \href{https://set-p-dsb-zomercursus-latest.cloud-ext.icts.kuleuven.be/differentialequations/main/separableEquations/separableEquations}{separable equations}. (Verify.)
