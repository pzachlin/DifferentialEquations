...
of $Ly=0$, we will also say that $p_0$ is the \dfn{indicial
polynomial} of $\eqref{eq:7.5.2}$, and that $p_0(r)=0$ is the \dfn{indicial equation} of $Ly=0$. We shall only consider cases where the
...
defined for $r=r_2$ if $r_1-r_2$ is not an \dfn{even} integer. It can be
