...
\begin{tikzpicture}[scale=2]
  \fill[fill=blue!20] (2,0)node[below] {$t_0$} --(2.5,0)node[below] {$t_0+h$}--(2.5,2)--(2,2)-- cycle;
\draw[-, dashed] (2,2)-- (0,2) node[left] {$\frac{1}{h}$};
\draw[-, blue] (2,2)-- (2.5,2);
...
\begin{tikzpicture}[scale=1]
        \begin{axis}[
         xmin=0, xmax=8.5,
          ...
          width=5in,
          height=3in,
          xtick={0.5,2,3,4,5,6,7},
          xticklabels={$t_0$,$t_0+1$,$t_0+2$,$t_0+4$,$t_0+5$,$t_0+6$,$t_0+7$},
...
\addplot[domain=0.5:8,smooth, thick, blue] {(x-0.5)*exp(-(x-0.5))};
...
\addplot[domain=0:1,smooth, thick, blue] {-exp(-2*x)+0.5*exp(-5*x)-2.5*exp(-x)};

\addplot[domain=1:4,smooth, thick, blue] {-exp(-2*x)+0.5*exp(-5*x)-2.5*exp(-x)+(exp(-(x-1))-exp(-5*(x-1)))/2};

\draw[-,dashed](1,-0.2)--(1,-1.5)node[right]{$t=1$};
...
\addplot[domain=0:pi,smooth, thick, blue] {1-2*cos(x)+2*sin(x)};

\addplot[domain=pi:2*pi,smooth, thick, blue] {1-2*cos(x)};

\addplot[domain=2*pi:13,smooth, thick, blue] {1-2*cos(x)-3*sin(x)};

\draw[-,dashed](pi,-2)--(pi,4)node[above]{$t=\pi$};
\draw[-,dashed](2*pi,-2)--(2*pi,4)node[above]{$t=2\pi$};
