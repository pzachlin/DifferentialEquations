...
in \href{https://xerxes.ximera.org/differentialequations/main/laplaceTable/laplaceTable}{Trench 8.8} 
...
\addplot[domain=-0.4:2,smooth, thick, blue] {0.5*x^2+1};
\addplot[domain=2:4,smooth, thick, blue] {-(0.1)*(2^(x))+5};

\draw[-, black,dashed] (2,3) -- (0,3) node[left] {$f(t_0-)$};
\draw[-, dashed, black] (2,4.6) -- (0,4.6) node[left] {$f(t_0+)$};
\draw[-, dashed, black] (2,4.6) -- (2,0) node[below] {$t_0$};
...
\addplot[domain=-0.4:4,smooth, thick, blue] {0.5*x^2+1};
\fill[white] (2,3) circle (0.1);


\draw[-, black,dashed] (2,3) -- (0,3) node[left] {$f(t_0-)=f(t_0+)$};
\draw[-, dashed, black] (2,4.6) -- (0,4.6) node[left] {$f(t_0)$};
\draw[-, dashed, black] (2,4.6) -- (2,0) node[below] {$t_0$};
...
\addplot[domain=0.4:2,smooth, thick, blue] {-0.5*x+2};
\addplot[domain=5:6,smooth, thick, blue] {x-4};
\addplot[domain=2:3,smooth, thick, blue] {-0.5*x^3+10*x-14};
\addplot[domain=3:5,smooth, thick, blue] {0.5*(x-3)^2+1};


\draw[-, dashed, black] (0.4,0)node[below] {$a$} -- (0.4,1.8);
\draw[-, dashed, blue] (6,0)node[below] {$b$} -- (6,2);

\draw[-, dashed, black] (2,0)-- (2,2);
\draw[-, dashed, black] (3,0)-- (3,2.5);
\draw[-, dashed, black] (5,0)-- (5,3);
...
\begin{remark}
In \href{https://xerxes.ximera.org/differentialequations/main/unitStepFunction/unitStepFunction}{Trench 8.4} we will develop a more efficient
